...
const galleries = {
  ...
  viti: {
    ita: [viti1, viti2, viti3, viti4, viti5, viti6],
    eng: [viti1_en, viti2, viti3, viti4, viti5, viti6],
    // colored: viti1Colored,
    // gif: vitiGif1,
  },
  cantina: {
    ita: [cantina1, cantina2, cantina3, cantina4, cantina5, cantina6],
    // colored: cantina1Colored,
    // gif: cantinaGif1,
    eng: [cantina1_en, cantina2, cantina3, cantina4, cantina5, cantina6],
  },
  prodotti: {
    ita: [prodotti1, prodotti2, prodotti3],
    // colored: prodotti1Colored,
    // gif: prodottiGif1,
    eng: [prodotti1_en, prodotti2, prodotti3],
  },
  galleryCustom: {
    arrowSx,
    arrowDx,
